      ...
      <div>
        <div className="card mt-1">
          <div className="card-body align-items-center d-flex justify-content-center">
            <h5>Color Your Blockchain Software Developer's skills as you wish.</h5>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-md-3">
              <div className="form-group">
                <label htmlFor="cardBorderColor">Full Stack Blockchain</label>
                <input
                  required
                  type="color"
              ...
              <div className="form-group">
                <label htmlFor="headBorderColor">Go</label>
                <input
                  required
                  type="color"
            ...
            <div className="col-md-6 d-flex justify-content-center align-items-center">
              <SoftwareDeveloperNFTImage colors={this.state.userSelectedColors[0]} />
            </div>
          </div>
          <div className="row">
            <div className="col-md-3">
              ...
              <div className="form-group">
                <label htmlFor="mouthColor">NextJS</label>
                <input
                  required
                  type="color"
                  name="mouthColor"
            ...
            <div className="col-md-3">
              <div className="form-group">
                <label htmlFor="neckBorderColor">Solidity</label>
                <input
                  required
                  type="color"
              ...
              <div className="form-group">
                <label htmlFor="bodyBorderColor">ReactJS</label>
                <input
                  required
                  type="color"
            ...
            <div className="col-md-6">
              <div className="form-group">
                ...
                <input
                  ...
                  className="form-control"
                  placeholder="Enter Your Software Developer's Name"
                  onChange={(e) =>
